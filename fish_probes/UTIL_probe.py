...
def create_to_print(sequence, header = False, split = False):
    if header:
        if split:
            ...
            # half
            this_str = "GC_content\tsequence_entropy\tmelting_temperature\tprobe_accessibility\tPleft_GC_content\tPleft_sequence_entropy\tPleft_melting_temperature\tPleft_probe_accessibility\tPright_GC_content\tPright_sequence_entropy\tPright_melting_temperature\tPright_probe_accessibility\n"
        else:
            this_str = "GC_content\tsequence_entropy\tmelting_temperature\tprobe_accessibility\n"
    else:
        this_str = ""
    ...
    this_str = this_str+str(probe_accessibility(sequence))
    ...
    if split:
        ...
        this_str = this_str+str(probe_accessibility(probe_left))+"\t"
        # right
